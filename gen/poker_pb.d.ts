...
/**
 * @generated from message pokerhero.AdminTxRequest
 */
export declare class AdminTxRequest extends Message<AdminTxRequest> {
  /**
  ...
  /**
   * @generated from field: bool retry = 2;
   */
  retry: boolean;
  ...
  constructor(data?: PartialMessage<AdminTxRequest>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "pokerhero.AdminTxRequest";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AdminTxRequest;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AdminTxRequest;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AdminTxRequest;

  static equals(a: AdminTxRequest | PlainMessage<AdminTxRequest> | undefined, b: AdminTxRequest | PlainMessage<AdminTxRequest> | undefined): boolean;
}

/**
 * @generated from message pokerhero.AdminTxResponse
 */
export declare class AdminTxResponse extends Message<AdminTxResponse> {
  /**
   * @generated from field: int32 id = 1;
   */
  id: number;

  constructor(data?: PartialMessage<AdminTxResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "pokerhero.AdminTxResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AdminTxResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AdminTxResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AdminTxResponse;

  static equals(a: AdminTxResponse | PlainMessage<AdminTxResponse> | undefined, b: AdminTxResponse | PlainMessage<AdminTxResponse> | undefined): boolean;
}
