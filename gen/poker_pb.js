 ...
 */
export const AdminTxRequest = proto3.makeMessageType(
  "pokerhero.AdminTxRequest",
  () => [
 ...
 */
export const AdminTxResponse = proto3.makeMessageType(
  "pokerhero.AdminTxResponse",
  () => [
